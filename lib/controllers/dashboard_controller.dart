...
class DashboardController extends GetxController {
  ...
  Future<void> loadDashboardData() async {
    print('[DEBUG] DashboardController: loadDashboardData START'); // 로그 추가
    isLoading.value = true;

    try {
      print('[DEBUG] DashboardController: Loading summary data...'); // 로그 추가
      await _loadSummaryData();
      print('[DEBUG] DashboardController: Summary data loaded.'); // 로그 추가

      print(
          '[DEBUG] DashboardController: Loading statistics for ${selectedPeriod.value}...'); // 로그 추가
      await _loadStatistics(selectedPeriod.value);
      print('[DEBUG] DashboardController: Statistics loaded.'); // 로그 추가
    } catch (e, stackTrace) {
      // 스택 트레이스도 출력
      print('[DEBUG] DashboardController: ERROR loading dashboard data: $e');
      print('[DEBUG] StackTrace: $stackTrace'); // 스택 트레이스 출력
      Get.snackbar(
        '오류',
      ...
      print('[DEBUG] DashboardController: Setting isLoading to false'); // 로그 추가
