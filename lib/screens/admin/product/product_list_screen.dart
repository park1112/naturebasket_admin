                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      _buildStatusBadge(product.isActive, product.stockStatus),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      if (product.salePrice != null) ...[
                        const SizedBox(width: 8),
                        Text(
                          '${product.salePrice!.toStringAsFixed(0)}원',
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Colors.red,
                  ...
                  DataCell(
                    Column(
                      ...
                      children: [
                        ...
                        if (product.salePrice != null)
                          Text(
                            '${product.salePrice!.toStringAsFixed(0)}원 (${product.discountPercentage.toStringAsFixed(0)}%↓)',
                            style: const TextStyle(
                              fontSize: 12,
                              color: Colors.red,
                              fontWeight: FontWeight.bold,
