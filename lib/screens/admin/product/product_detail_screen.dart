                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        decoration: _product!.salePrice != null
                            ? TextDecoration.lineThrough
                            : null,
                        color: _product!.salePrice != null
                    ...
                    if (_product!.salePrice != null) ...[
                      ...
                      Row(
                        children: [
                          Text(
                            '${_product!.salePrice!.toStringAsFixed(0)}원',
                            style: const TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: Colors.red,
                          ...
                          Container(
                            ...
                            child: Text(
                              '${_product!.discountPercentage.toStringAsFixed(0)}% 할인',
                              style: const TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
                                color: Colors.red,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            else if (_product!.tags.isNotEmpty) ...[
              const Text(
                '태그',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
            ...
            if (!_isEditing) ...[
              ...
              Text('최종 수정일: ${_formatDateTime(_product!.updatedAt)}'),
            ],
          ],
        ),
      ),
